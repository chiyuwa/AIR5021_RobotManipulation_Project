...
def command_callback(data):
    ...
    if index < count:
        if not has_detection:
            rospy.logwarn("No blue block detected in current frame. Please adjust HSV thresholds or place the blue block clearly under the camera.")
            return
...
def main():
    ...
    rospy.loginfo("Calibration node is ready. Waiting for image frames and cali_pix_topic trigger.")
