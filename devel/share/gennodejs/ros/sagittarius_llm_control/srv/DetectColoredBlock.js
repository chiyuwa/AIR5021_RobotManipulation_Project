...
class DetectColoredBlockRequest {
  constructor(initObj={}) {
    if (initObj === null) {
  ...
  static serialize(obj, buffer, bufferOffset) {
    // Serializes a message object of type DetectColoredBlockRequest
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    //deserializes a message object of type DetectColoredBlockRequest
    let len;
    let data = new DetectColoredBlockRequest(null);
  ...
  static Resolve(msg) {
    ...
    const resolved = new DetectColoredBlockRequest(null);
...
class DetectColoredBlockResponse {
  constructor(initObj={}) {
    if (initObj === null) {
      // initObj === null is a special case for deserialization where we don't initialize fields
      this.success = null;
  ...
  static serialize(obj, buffer, bufferOffset) {
    // Serializes a message object of type DetectColoredBlockResponse
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    //deserializes a message object of type DetectColoredBlockResponse
    let len;
    let data = new DetectColoredBlockResponse(null);
  ...
  static Resolve(msg) {
    ...
    const resolved = new DetectColoredBlockResponse(null);
...
module.exports = {
  Request: DetectColoredBlockRequest,
  Response: DetectColoredBlockResponse,
  md5sum() { return '2067dc8c08ea01b0be7723ab7195563c'; },
  datatype() { return 'sagittarius_llm_control/DetectColoredBlock'; }
};
